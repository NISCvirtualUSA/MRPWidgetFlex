...
[Bindable]
public class ResultItemMRP
{
    public function ResultItemMRP(graphic:Graphic, attributes:ResultAttributesMRP)
    {
        _graphic = graphic;
    ...
    private var _attributes:ResultAttributesMRP;

    public function get attributes():ResultAttributesMRP
    {
        return _attributes;
    }
